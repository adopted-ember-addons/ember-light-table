...
module('light-table', function(hooks) {
  ...
  hooks.beforeEach(function() {
    ...
    this.createUsers = (numUsers = 20) => {
      this.server.createList('user', numUsers);
  ...
  test('it renders', async function(assert) {
    ...
    await this.render(hbs `{{light-table table}}`);
  ...
  test('scrolled to bottom', async function(assert) {
    ...
    this.set('table', new Table(Columns, this.createUsers(50)));
  ...
  test('fixed header', async function(assert) {
    assert.expect(2);
    this.set('table', new Table(Columns, this.createUsers(5)));
  ...
  test('onScroll', async function(assert) {
    let table = new Table(Columns, this.createUsers(10));
